...
ALARM_PATH := vendor/blitz/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/blitz/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/blitz/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/blitz/prebuilt/common/media/audio/ui
